...
// import { createAppKit, defaultAppKitConfig } from "@reown/appkit-react-native";
// import type { Storage } from "@reown/appkit-react-native";
// import AsyncStorage from "@react-native-async-storage/async-storage";
...
// /**
//  * AppKit Configuration for Soul Link
//  *
//  * This sets up WalletConnect v2 integration for React Native.
//  * Users can connect: Trust Wallet, Bybit, Phantom, MetaMask, and others.
//  */
...
// if (!projectId) {
//   console.warn(
//     "⚠️  WalletConnect Project ID not set. Please set EXPO_PUBLIC_WALLETCONNECT_PROJECT_ID in .env",
//   );
// }

// const metadata = {
//   name: "Soul Link",
//   description: "Web3 Social App - Web3 Social App - Own Your Digital Soul",
//   url: "https://soullink.com.ng",
//   icons: ["https://soullink.com.ng/assets/logo.png"],
//   redirect: {
//     native: "soul-link://",
...
// /**
//  * Storage adapter for AppKit to work with AsyncStorage
//  */
// const storageAdapter: Storage = {
...
//     const keys = await AsyncStorage.getAllKeys();
//     const rawValues = (await AsyncStorage.multiGet(keys)) as Array<[string, string | null]>;
//     const entries = rawValues
//       .filter((item): item is [string, string] => item[1] !== null)
//       .map(([key, value]) => [key, value as unknown as T]);
//     return entries as [string, T][];
//   },
// };

// /**
//  * Initialize AppKit with Reown configuration
//  * Supports: Trust Wallet, Bybit, Phantom, MetaMask, WalletConnect universal bridge
//  */
...
//   adapters: [new EthersAdapter()],
//   defaultNetwork: mainnet,
//   storage: storageAdapter, // <--- Add this line
// });
