        ...
        >
          ...
          >
            ...
            <View className="space-y-6">
              ...
              >
                <Text className="text-[#5EEAD4] font-medium">
                  Forgot Password?
                </Text>
              </TouchableOpacity>
              ...
              >
                {loading ? (
                  ...
                  <Text className="text-[#05070A] font-bold text-xl">
                    Log In
                  </Text>
                )}
              </TouchableOpacity>
        ...
        <View className="flex-1 bg-black/60 items-center justify-center px-6">
          <View className="bg-[#0F1219] w-full p-8 rounded-[40px] border border-white/10">
            ...
            <Text className="text-slate-400 mb-6 text-base">
              Enter your email and we'll send you a 6-digit token to reset your
              password.
            </Text>
            ...
            >
              {forgotLoading ? (
                ...
                <>
                  <Text className="text-[#05070A] font-bold text-lg mr-2">
                    Send Token
                  </Text>
